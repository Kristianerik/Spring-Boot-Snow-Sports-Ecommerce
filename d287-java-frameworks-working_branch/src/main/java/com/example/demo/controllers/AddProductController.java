...
public class AddProductController {
    ...
    public String submitForm(@Valid @ModelAttribute("product") Product product, BindingResult bindingResult, Model theModel) {
        ...
        else if (!EnufPartsValidator.validatePartsInventory(product)) {
            bindingResult.rejectValue("inv", "error.product", "Product inventory exceeds maximum associated part inventory or associated part minimum inventory.");
            return "productForm";
        }
