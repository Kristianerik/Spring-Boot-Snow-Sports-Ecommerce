...
class PartTest {
    ...
    void testMinimumInventory() {
        int minInv = 5; //assumed minimum inventory value
        partIn.setMinimumInventory(minInv);
        assertEquals(minInv, partIn.getMinimumInventory());
        partOut.setMinimumInventory(minInv);
        assertEquals(minInv, partOut.getMinimumInventory());
    }
    @Test
    void testMaximumInventory() {
        int maxInv = 100; // assumed maximum inventory value
        partIn.setMaximumInventory((maxInv));
        assertEquals(maxInv, partIn.getMaximumInventory());
        partOut.setMaximumInventory(maxInv);
        assertEquals(maxInv, partOut.getMaximumInventory());
    }
